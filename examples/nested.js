...
console.time("diff");
console.log(
  colors.red(`a red ${colors.bold(colors.yellow("and bold yellow"))} message`)
);
console.timeEnd("diff");
console.time("diff");
console.log(
  colors.bold(
    colors.green(
      `a bold green ${colors.bold(colors.yellow("and bold yellow"))} message`
    )
  )
);
console.timeEnd("diff");
...
console.log(
  colors.red(
    `a red ${colors.white("white")} red ${colors.red("red")} red ${colors.gray(
      "gray"
    )} red ${colors.red("red")} red ${colors.red("red")} red ${colors.red(
      "red"
    )} red ${colors.red("red")} red ${colors.red("red")} red ${colors.blue(
      "blue"
    )} red ${colors.red("red")} red ${colors.red("red")} red ${colors.red(
      "red"
    )} red ${colors.red("red")}red ${colors.red("red")} red ${colors.red(
      ...
      "red"
    )} red ${colors.red("red")} red ${colors.red("red")}red ${colors.cyan(
      "cyan"
    )} red ${colors.red("red")} red ${colors.red("red")} red ${colors.red(
      "red"
    )} red ${colors.red("red")} red ${colors.red("red")} red ${colors.red(
      ...
      "red"
    )}red ${colors.red("red")} red ${colors.yellow("yellow")} red ${colors.red(
      "red"
    )} red ${colors.red("red")} red ${colors.red("red")} red ${colors.red(
      "red"
...
console.log(
  colors.yellow(
    `foo ${colors.red(colors.bold("red"))} bar ${colors.cyan("cyan")} baz`
  )
);
