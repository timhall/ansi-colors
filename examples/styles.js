...
console.log(
  c.bold(c.green(`a bold green ${c.bold(c.yellow("and bold yellow"))} message`))
);
...
console.log(
  c.bold(c.yellow(c.italic("this is a bold yellow italicized message")))
);
console.log(
  c.green(c.bold(c.underline("this is a bold green underlined message")))
);
